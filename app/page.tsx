...
export default function Home() {
  return (
    <div className="relative overflow-x-hidden" style={{ background: "#0d0d1a", height: "100dvh", overflowY: "scroll", scrollSnapType: "y mandatory" }}>
      ...
      {/* Navbar */}
      <nav className="sticky top-0 z-20 flex items-center justify-between px-8 py-3 md:px-16" style={{ background: "rgba(13,13,26,0.85)", backdropFilter: "blur(12px)" }}>
        <span className="text-lg font-bold text-white tracking-tight">Manuel Bolla</span>
      ...
      <section
        id="home"
        className="relative z-10 flex flex-col items-center justify-center gap-12 px-8 md:flex-row md:justify-between md:px-16 lg:px-28"
        style={{ minHeight: "100dvh", scrollSnapAlign: "start" }}
      >
        {/* Left: text */}
        <div className="flex-1 text-left">
          <p className="text-3xl font-light text-white md:text-4xl">Hi There! 👋</p>
          ...
          <div className="mt-5 flex items-center gap-3">
            <p className="text-xl font-medium text-purple-300 md:text-2xl">
        ...
        <div className="relative flex-shrink-0">
          ...
          />
          <div className="relative overflow-hidden rounded-full" style={{ width: 320, height: 320, boxShadow: "0 0 0 2px #a855f7" }}>
            <Image
      ...
      <section
        id="about"
        className="relative z-10 px-8 py-24 md:px-16 lg:px-28"
        style={{ minHeight: "100dvh", scrollSnapAlign: "start" }}
      >
        <h2 className="text-center text-2xl font-semibold tracking-wide text-white md:text-3xl">
          Let Me{" "}
          <span className="text-purple-400">Introduce</span>{" "}
          Myself
        </h2>

        <div className="mx-auto mt-14 max-w-3xl space-y-5 text-base leading-8 text-zinc-300">
          <p>
        ...
        <div className="mt-20 text-center">
          <h3 className="text-2xl font-bold uppercase tracking-widest text-white md:text-3xl">
            Find Me On
          </h3>
          ...
          <a
            href="mailto:manubolla17@gmail.com"
            className="mt-4 inline-block text-base font-medium text-purple-300 hover:text-white transition-colors"
          >
      ...
      {/* Experience */}
      <section id="experience" className="relative z-10 px-8 py-24 md:px-16 lg:px-28" style={{ minHeight: "100dvh", scrollSnapAlign: "start" }}>
        <h2 className="text-center text-3xl font-bold uppercase tracking-widest text-white md:text-4xl">
        ...
        <div className="mx-auto mt-14 max-w-3xl space-y-10">
          ...
          <div className="relative border-l-2 border-zinc-800 pl-8">
            ...
            <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <h3 className="text-lg font-semibold text-white">React Native Developer</h3>
                <p className="text-sm text-purple-400">Nicasource</p>
              </div>
              <span className="text-xs text-zinc-500">2021 — 2025 · United States</span>
            </div>
            <ul className="mt-4 space-y-3 text-base leading-7 text-zinc-400">
          ...
          <div className="relative border-l-2 border-zinc-800 pl-8">
            ...
            <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <h3 className="text-lg font-semibold text-white">React Native Developer</h3>
                <p className="text-sm text-purple-400">BINIT</p>
              </div>
              <span className="text-xs text-zinc-500">Feb 2021 — Nov 2021 · Argentina</span>
            </div>
            <ul className="mt-4 space-y-3 text-base leading-7 text-zinc-400">
      ...
      {/* Footer */}
      <footer className="relative z-10 border-t border-zinc-800 py-6 text-center text-xs text-zinc-600">
